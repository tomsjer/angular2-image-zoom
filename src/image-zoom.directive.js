...
var ImageZoom = /** @class */ (function () {
    function ImageZoom(_elementRef, _componentFactoryResolver, _viewContainerRef, sanitizer) {
        var _this = this;
        ...
        this.img.onload = function () {
            ...
            if (_this._componentsCreated) { // Possible race condition if the component resolver hasn't finished yet
                _this.imageChanged();
            }
        };
