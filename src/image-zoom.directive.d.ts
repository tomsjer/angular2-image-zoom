...
export declare class ImageZoom implements OnInit, OnDestroy, OnChanges {
    ...
    constructor(_elementRef: ElementRef, _componentFactoryResolver: ComponentFactoryResolver, _viewContainerRef: ViewContainerRef, sanitizer: DomSanitizer);
    private imageChanged;
    private setImageZoomContainer;
    private setImageZoomContainerVisiblity;
    private setImageZoomLens;
    private setImageZoomLensVisibility;
